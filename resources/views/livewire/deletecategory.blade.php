    ...
    <div x-show="open" @click.away="open = false" class="modal">
        <div class="modal-content">
            ...
            <form wire:submit.prevent="deleteCategory">
                <div class="mb-4">
                    <label for="new_category_id" class="block text-sm font-medium text-gray-700">Select new category for existing transactions or press delete to keep the category in your history:</label>
